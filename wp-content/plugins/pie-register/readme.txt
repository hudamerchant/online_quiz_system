...
**Advanced Fields**
Advanced fields section provides fields you can use to create complex and detailed registration forms. Advanced Fields include:
* Address Field
* Profile Picture Field
* Upload File Field
* List Field
* Time and Date Picker Field
* Math Captcha and Re-Captcha Field
* Custom User Role Field
* Invitation Codes Field
* Membership Field
...
Set Grace Period – User Ids that are not verified within the grace period are deleted automatically.
...
Protect your site's privacy and prevent unwanted registrations by easily setting invitation codes by defining limit usage. Specify the Invitation Codes from the Field settings to allow registration on a particular form through these codes only.
...
**[Timed form submission](https://pieregister.com/features/timed-form-submission/)**
Prevent bots with event timed submission.

**[Limit Form Submissions (Device)](https://pieregister.com/features/limit-form-submissions/)**
Limit the number of forms submitted from a device in a day. This feature helps prevent spam submissions and keep your website secure.
...
**[User Roles](https://pieregister.com/features/custom-user-roles/)**
...
Add Admin Email Templates for individual forms.
